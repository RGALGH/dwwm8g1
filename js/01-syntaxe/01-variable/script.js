...
/* 
    "use strict"; indique à js de ne pas corriger les petites erreurs dont il comprend le sens, la moindre erreur sera signalé.
*/
...
// console.log(gLet, gVar, hVar, hLet);
...
// --------------------- TYPES des variables -----------------------
let num = 5, // numérique, on peut aussi mettre des chiffre a virgule ex num 1.23
	str = "Coucou", //entre "" ou entre ''
	bol = true, // booleen
	arr = [], // un tableau contient plusieurs valeurs
	obj = {},
	und;
...
/* 
	JS est un langage non typé, on peut donc changer le type d'une variable à tout moment.
*/
...
s2 = "L'apostrophe pose problème ici";
...
let n = 0;
n = n + 5;
n += 5; // version courte de la ligne précédente
n -= 2; // version courte de n = n -2
n *= 3; // version courte de n = n * 3
n /= 4; // version courte de n = n / 4
console.log(n);
